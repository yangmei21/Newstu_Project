...
class TestLogin(unittest.TestCase):
    ...
    def test_login(self, username, password):
        ...
        '''验证是否可以正确登录'''
        time.sleep(2)
        # self.driver.find_element_by_class_name("ng-tns-c58-51 ant-input-affix-wrapper ant-input-affix-wrapper-lg").clear()  # 清空原文本框内容
        ...
        # 查找输入密码的文本框，并输入密码
        time.sleep(2)
        # self.driver.find_element_by_class_name("ant-input ng-untouched ng-pristine ng-invalid ant-input-lg ng-star-inserted").clear()  # 清空原密码框内容
